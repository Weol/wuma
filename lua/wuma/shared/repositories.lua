...
Settings:SetAuthenticationCallback(CAMI.PlayerHasAccess)
...
Inheritance:SetAuthenticationCallback(CAMI.PlayerHasAccess)
...
Subscription:SetAuthenticationCallback(CAMI.PlayerHasAccess)
...
CVarLimits:SetAuthenticationCallback(CAMI.PlayerHasAccess)
...
Groups:SetAuthenticationCallback(CAMI.PlayerHasAccess)
...
Users:SetAuthenticationCallback(CAMI.PlayerHasAccess)
...
User:SetAuthenticationCallback(CAMI.PlayerHasAccess)
...
Lookup:SetAuthenticationCallback(CAMI.PlayerHasAccess)
...
Maps:SetAuthenticationCallback(CAMI.PlayerHasAccess)
...
WhoIs:SetAuthenticationCallback(CAMI.PlayerHasAccess)
...
Restrictions:SetAuthenticationCallback(function(user, callback)
	CAMI.PlayerHasAccess(user, "wuma gui", callback)
end)
...
Loadouts:SetAuthenticationCallback(CAMI.PlayerHasAccess)
...
Personal:SetAuthenticationCallback(function(user, callback)
	CAMI.PlayerHasAccess(user, "wuma personalloadout", callback)
end)
...
RestrictionItems:SetAuthenticationCallback(CAMI.PlayerHasAccess)