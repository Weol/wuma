...
--Restrict
	...
	restrict:addParam{ type=ULib.cmds.StringArg, completes=table.GetKeys(Restriction:GetTypes()), hint="type", error="invalid typ =\"%s\" specified", ULib.cmds.restrictToCompletes }
